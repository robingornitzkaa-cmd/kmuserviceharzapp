...
- [x] **⚡ [Prompts] God of Prompt Integration (453 Vorlagen, 20 Fachgebiete):** Vollständige Extraktion, Formatierung und native Integration der God-of-Prompt-Bibliothek (inkl. SOPs & Prozesse, Workflow Design und Projektmanagement) in den Prompt Vault. Inklusive Subkategorien-Filterleiste, 1-Klick-Übernahme, Batch-Import, JSON-Exportdatei (`public/godofprompt_library_export.json`), Chunk-Splitting und Tests.
