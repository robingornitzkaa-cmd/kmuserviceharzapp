...
### Warum
Damit To-Dos und Logbucheinträge nicht auseinanderdriften und du ein echtes, voll funktionsfähiges Synchronisations-Erlebnis mit Google Drive hast, um deine Dokumente direkt in Google NotebookLM einlesen zu können.

### Testen
- `npm run test` ausgeführt. Alle 8 Integrationstests laufen zu 100% grün durch.
- Getestet, dass Checkbox-Klicks den Text spiegeln und Texteingaben im Editor die Checkboxen aktualisieren.
