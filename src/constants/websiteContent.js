export const WEBSITE_CONTENT = {
  ...
  privacy: {
    ...
    intro: "Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Nachfolgend informieren wir Sie über die Verarbeitung personenbezogener Daten auf unserer Webseite gemäß DSGVO.",
    sections: [
      {
        heading: "1. Datenschutz auf einen Blick",
        content: "Diese Webseite erhebt keine unnötigen personenbezogenen Daten. Wir setzen keine externen Tracking-Pixel oder Werbe-Cookies ein. Alle Schriftarten werden lokal gehostet, sodass keine IP-Adressen an externe Server übertragen werden."
      },
      {
        heading: "2. Datenerfassung bei Kontaktaufnahme",
